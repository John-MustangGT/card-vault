...
async fn main() -> Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/ledger", get(routes::ledger::ledger_page))
        .route("/ledger", post(routes::ledger::create_entry))
        .route("/ledger/:id/delete", post(routes::ledger::delete_entry))
        .route("/sealed", get(routes::sealed::sealed_page))
        .route("/sealed", post(routes::sealed::create_sealed))
